...
namespace Unity.Rendering
{
    ...
    [BurstCompile]
    // TODO: Rewrite with IJobChunk, IJobForEach is deprecated
    unsafe struct SelectLodEnabled : IJobForEach<HybridChunkInfo, ChunkHeader>
    {
...
#pragma warning restore 649
        ...
        public void Execute(ref HybridChunkInfo hybridChunkInfo, ref ChunkHeader chunkHeader)
        {
    ...
    [BurstCompile]
    // TODO: Rewrite with IJobChunk, IJobForEach is deprecated
    unsafe struct SimpleCullingJob : IJobForEach<HybridChunkInfo, ChunkWorldRenderBounds, ChunkHeader>
    {
...
#pragma warning restore 649
        ...
        public void Execute(ref HybridChunkInfo hybridChunkInfo, ref ChunkWorldRenderBounds chunkBounds, ref ChunkHeader chunkHeader)
        {
            if (!hybridChunkInfo.Valid)
                return;
